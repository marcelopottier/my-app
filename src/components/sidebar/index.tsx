...
import { Home, ListCollapse, LogOut, Package, PanelBottom, Users } from "lucide-react";
                    ...
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link
                                    href="/"
                                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-log text-muted-foreground transition-colors hover:text-foreground"
                                >
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link
                                    ...
                                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-log text-muted-foreground transition-colors hover:text-foreground"
                                >
                                    <ListCollapse className="h-4 w-5"/>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link
                                    ...
                                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-log text-muted-foreground transition-colors hover:text-foreground"
                                >
                                    <LogOut className="h-4 w-5 text-red-500"/>
